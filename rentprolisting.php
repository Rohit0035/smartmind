                ...
                <form>
                    ...
                    <div class="form-check mb-3">
                        ...
                        <label class="form-check-label" for="agreeTerms">
                            I Agree to MagicBricks' <a href="propertydetails.php">Terms of Use</a>
                        </label>
                    </div>
...
<!-- script card owl image -->
<script>
$(document).ready(function() {
    $(".prorentlist").owlCarousel({
        items: 1,
        loop: true,
        margin: 10,
        nav: false,
