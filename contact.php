                ...
                <div class="row">
                        ...
                        <div class="contact-content">
                            <div class="contact-info">
                                ...
                                <div class="contact-info-content">
                                    ...
                                    <p> 3rd Floor, AR Plaza, 18/9, 100 Feet Ring Rd, KEB Colony, New Gurappana Palya, BTM 1st Stage, Bengaluru, Karnataka 560029</p>
                                </div>
                            </div>
                            <div class="contact-info">
                                <div class="contact-info-icon">
                                ...
                                <div class="contact-info-content">
                                    <h5>Call Us</h5>
                                    <p> +91 99167 90207, +91-9110231169</p>
                                </div>
                            </div>
                            <div class="contact-info">
                                <div class="contact-info-icon">
                                ...
                                <div class="contact-info-content">
                                    <h5>Email Us</h5>
                                    <p><a href="mailto:enquiry@mindsmart.in"
                                            class="__cf_email__"
                                            data-cfemail=""> enquiry@mindsmart.in</a>
                                    </p>
                                </div>
                            </div>
                            <!-- <div class="contact-info">
                    ...
                    <div class="col-lg-8 align-self-center">
                        <div class="contact-form">
                            ...
                            <form method="post" action="https://live.themewild.com/homfind/assets/php/contact.php"
                                id="contact-form">
                                <div class="row">
                                    <div class="col-md-6">
